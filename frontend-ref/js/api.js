...
export const evaluationsApi = {
  create: async (body) => {
    if (MOCK_MODE) {
      ...
      const novaAvaliacao = {
        id: `eval-${Date.now()}`,
        avaliadorId: getToken() ? JSON.parse(atob(getToken().split('.')[1] || 'e30=')).userId : 'unknown',
...
export const nineBoxApi = {
  create: async (body) => {
    ...
    return api.post('/evaluations/nine-box', body);
  },
  ...
  list: async (params) => {
    ...
    return api.get(`/evaluations/nine-box${buildQuery(params)}`);
  },
  ...
  getByPessoa: async (id) => {
    ...
    return api.get(`/evaluations/nine-box/pessoa/${id}`);
  },
  ...
  getLatest: async (id) => {
    ...
    return api.get(`/evaluations/nine-box/pessoa/${id}/latest`);
  },
  ...
  getDistribution: async () => {
    ...
    return api.get('/evaluations/nine-box/stats/distribution');
  },
  ...
  delete: async (id) => {
    ...
    return api.delete(`/evaluations/nine-box/${id}`);
  },
};
